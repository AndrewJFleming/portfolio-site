 ...
 const About = () => {
    ...
    return (
            <Container className="about-container">
                <Card className="bg-primary p-4 about-card">
                    <Col xs={12} sm={12} lg={12} smOffset={2}>
                        ...
                        <p>Recent noteworthy freelance work includes a website for <a style={{color: "#202f5f", fontWeight: "600"}} href="https://andrewjfleming.github.io/portraits-of-iowa/">Portraits of Iowa</a>, a project commissioned for a public art installation in Cedar Rapids, Iowa. My client's installation involved gathering hundreds of photo submissions from Cedar Rapids residents that would then be assembled into a hanging gallery/sculpture; I was hired to design a website that would outline the planned project to community contributors, would provide them with image-submission instructions as well as an image-upload component for sending photos to Firebase storage.</p>
                        <p>
